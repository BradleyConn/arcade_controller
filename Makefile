...
OBJS := boot/startup_ARMCM4.o boot/isr_vector_extended.o kern/main.o kern/keyboard.o HAL_INCLUDES/system_stm32f4xx.o HAL_INCLUDES/stm32f4xx_it.o HAL_INCLUDES/usbd_desc.o HAL_INCLUDES/usbd_conf.o HAL_INCLUDES/usb_device.o HAL_INCLUDES/stm32f4xx_it.o
